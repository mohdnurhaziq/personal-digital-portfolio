...
import { isPhotoSectionEnabled } from '@/Components/Portfolio/photographerSections';
    ...
    return (
        <div className={`min-h-screen pb-25 ${theme.page}`}>
            ...
            >
                ...
                {isPhotoSectionEnabled(settings, 'photo_section_about_enabled') && (
                    <Section
                ...
                {isPhotoSectionEnabled(settings, 'photo_section_gear_enabled') && (
                    <Section
                        title="Gear"
                        theme={theme}
                ...
                {isPhotoSectionEnabled(settings, 'photo_section_gallery_enabled') && (
                    <Section title="Gallery" theme={theme}>
                        ...
                        {viewablePhotos.length === 0 && (
                            <p className={`mt-6 text-sm ${theme.body}`}>
                ...
                {isPhotoSectionEnabled(settings, 'photo_section_bookings_enabled') && (
                ...
                {isPhotoSectionEnabled(settings, 'photo_section_contact_enabled') && (
                    <ContactSection
