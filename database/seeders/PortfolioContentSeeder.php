...
class PortfolioContentSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $settings = [
            ...
            ['dev_ai_title', 'AI-assisted development', 'dev', 'text', 'AI section title'],
            ['dev_ai_intro', 'I use AI as a second set of eyes across discovery, delivery, and review — speeding up the feedback loop without outsourcing engineering judgment.', 'dev', 'textarea', 'AI section introduction'],
            ['dev_ai_tools', "Codex\nClaude Code\nGraphify", 'dev', 'textarea', 'AI tools (one per line)'],
            ['dev_ai_discovery', 'Map unfamiliar code, surface dependencies, and turn rough product intent into a scoped plan before changing the system.', 'dev', 'textarea', 'AI workflow — discovery'],
            ...
            ['photo_section_about_enabled', '1', 'photo', 'boolean', 'Behind the Photos'],
            ['photo_section_gear_enabled', '1', 'photo', 'boolean', 'Gear'],
            ['photo_section_gallery_enabled', '1', 'photo', 'boolean', 'Gallery'],
            ['photo_section_bookings_enabled', '1', 'photo', 'boolean', 'Bookings'],
            ['photo_section_contact_enabled', '1', 'photo', 'boolean', 'Contact'],
